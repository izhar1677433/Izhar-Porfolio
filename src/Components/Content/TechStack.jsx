    ...
    >
      ...
      <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 justify-around gap-20">
        {TechStackList.map((tech, index) => (
          <h2
            key={index}
            data-aos={tech.id % 2 === 0 ? "fade-down" : "fade-up"}
            className="text-[26px] flex items-center justify-center font-semibold text-fuchsia-800 rounded-3xl h-36 w-44 border-2 border-fuchsia-800 border-glow"
          >
